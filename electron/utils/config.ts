 ...
 */
export const PORTS = {
  /** NewClaw GUI development server port */
  NEWCLAW_DEV: 5173,
  
  /** NewClaw GUI production port (for reference) */
  NEWCLAW_GUI: 23333,

  /** Local host API server port */
  NEWCLAW_HOST_API: 13220,
...
export function getPort(key: keyof typeof PORTS): number {
  const envKey = `NEWCLAW_PORT_${key}`;
...
export const APP_PATHS = {
  ...
  /** NewClaw configuration directory */
  NEWCLAW_CONFIG: '~/.newclaw',
