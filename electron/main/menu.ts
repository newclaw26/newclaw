      ...
      submenu: [
        {
          label: 'Documentation',
          click: async () => {
            await shell.openExternal('https://newclaw.app');
          },
        },
        {
          label: 'Report Issue',
          click: async () => {
            await shell.openExternal('https://github.com/newclaw-ai/NewClaw/issues');
          },
        },
        { type: 'separator' },
        {
          label: 'NewClaw Documentation',
          click: async () => {
            await shell.openExternal('https://docs.newclaw.ai');
          },
        },
      ],
    },
