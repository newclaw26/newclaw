 ...
 * Communicates with NewClaw Gateway via renderer WebSocket RPC.
 */
...
const IMAGE_CACHE_KEY = 'newclaw:image-cache';
...
export const useChatStore = create<ChatState>((set, get) => ({
  ...
  // ── Delete session ──
  //
  // NOTE: The NewClaw Gateway does NOT expose a sessions.delete (or equivalent)
  ...
  loadHistory: async (quiet = false) => {
    ...
    const loadPromise = (async () => {
      ...
      // displayName (e.g. the configured agent name "NewClaw") instead.
