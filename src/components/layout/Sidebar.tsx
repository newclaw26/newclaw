...
export function Sidebar() {
  ...
  const opsItems = [
    { to: '/instances', icon: <Server className="h-[18px] w-[18px]" strokeWidth={2} />, label: '实例', testId: 'sidebar-nav-instances' },
    { to: '/sessions', icon: <MessageSquare className="h-[18px] w-[18px]" strokeWidth={2} />, label: '会话', testId: 'sidebar-nav-sessions' },
    { to: '/usage', icon: <BarChart3 className="h-[18px] w-[18px]" strokeWidth={2} />, label: '使用情况', testId: 'sidebar-nav-usage' },
    { to: '/documents', icon: <FileText className="h-[18px] w-[18px]" strokeWidth={2} />, label: '文档', testId: 'sidebar-nav-documents' },
  ];
      ...
      <div className={cn("flex items-center p-2 h-12", sidebarCollapsed ? "justify-center" : "justify-between")}>
        {!sidebarCollapsed && (
          <div className="flex items-center gap-2 px-2 overflow-hidden">
            <img src={logoSvg} alt="NewClaw" className="h-5 w-auto shrink-0" />
