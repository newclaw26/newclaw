  ...
  return (
    ...
    >
      <div className="w-full">
        ...
        {/* Input Row */}
        <div className={`relative glass rounded-[28px] shadow-sm border p-1.5 transition-all ${dragOver ? 'border-primary ring-1 ring-primary' : 'border-black/10 dark:border-white/10'}`}>
          {selectedTarget && (
          ...
          <div className="flex items-end gap-1.5">
            ...
            {showAgentPicker && (
              <div ref={pickerRef} className="relative shrink-0">
                ...
                {pickerOpen && (
                  <div className="absolute left-0 bottom-full z-20 mb-2 w-72 overflow-hidden rounded-2xl border border-black/10 glass-popover p-1.5 shadow-xl">
