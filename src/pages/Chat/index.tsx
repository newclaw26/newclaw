/**
 * Chat Page
 * Native React implementation communicating with NewClaw Gateway
...
export function Chat() {
  ...
  return (
    <div className={cn("relative flex flex-col -m-6 transition-colors duration-500 bg-transparent")} style={{ height: 'calc(100vh - 2.5rem)' }}>
      {/* Toolbar */}
